...
#include <gazebo_omni_plugins/gazebo_omni_plugins_pidConfig.h>
#include <gazebo_omni_plugins/gazebo_omni_plugins_pid.h>
...
void pid_callback(gazebo_omni_plugins::gazebo_omni_plugins_pidConfig &config, uint32_t level) 
{
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "gazebo_omni_plugin_pid");
  ros::NodeHandle n;
  ...
  dynamic_reconfigure::Server<gazebo_omni_plugins::gazebo_omni_plugins_pidConfig> pid_server;
  dynamic_reconfigure::Server<gazebo_omni_plugins::gazebo_omni_plugins_pidConfig>::CallbackType f;
  
  ros::Publisher gazebo_ros_omni_pid = n.advertise<gazebo_omni_plugins::gazebo_omni_plugins_pid>("gazebo_omni_plugins_PID", 50);
  ...
  {
    ros::spinOnce();
    gazebo_omni_plugins::gazebo_omni_plugins_pid wheel_PID_param;
    ...
    gazebo_ros_omni_pid.publish(wheel_PID_param);
