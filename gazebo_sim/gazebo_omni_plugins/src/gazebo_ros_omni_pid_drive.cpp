#include <gazebo_omni_plugins/gazebo_ros_omni_drive_ac.h>
...
namespace gazebo
{
    ...
    void GazeboRosMecanumDrive::Load(physics::ModelPtr parent, sdf::ElementPtr sdf)
    {
        ...
        ros::SubscribeOptions so_pid = ros::SubscribeOptions::create<gazebo_omni_plugins::gazebo_omni_plugins_pid>(wheel_pid, 1,
        ...
        Wheel_I_vel_pub_ = rosnode_->advertise<gazebo_omni_plugins::gazebo_omni_plugins_vel>(Wheel_I_vel, 1);
        Wheel_O_vel_pub_ = rosnode_->advertise<gazebo_omni_plugins::gazebo_omni_plugins_vel>(Wheel_O_vel, 1);
    ...
    void GazeboRosMecanumDrive::wheelPIDCallback(const gazebo_omni_plugins::gazebo_omni_plugins_pid::ConstPtr& msg)
    {
