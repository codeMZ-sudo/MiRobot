...
// (in-package gazebo_omni_plugins.msg)
...
class gazebo_omni_plugins_vel {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new gazebo_omni_plugins_vel(null);
  ...
  static datatype() {
    ...
    return 'gazebo_omni_plugins/gazebo_omni_plugins_vel';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new gazebo_omni_plugins_vel(null);
...
module.exports = gazebo_omni_plugins_vel;
