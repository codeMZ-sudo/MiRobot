...
if("TRUE" STREQUAL "TRUE")
  set(omni_description_SOURCE_PREFIX /home/mist/catking_ws/src/gazebo_sim/omni_description)
  set(omni_description_DEVEL_PREFIX /home/mist/catking_ws/devel/.private/omni_description)
  ...
  set(omni_description_INSTALL_PREFIX /home/mist/catking_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer ' <aleda.camino@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'omni_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mist/catking_ws/src/gazebo_sim/omni_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mist/catking_ws/devel/.private/omni_description/lib;/home/mist/catking_ws/devel/lib;/opt/ros/noetic/lib)
