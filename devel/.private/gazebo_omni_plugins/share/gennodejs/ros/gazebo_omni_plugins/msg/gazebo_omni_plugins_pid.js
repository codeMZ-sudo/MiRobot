...
class gazebo_omni_plugins_pid {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new gazebo_omni_plugins_pid(null);
  ...
  static datatype() {
    ...
    return 'gazebo_omni_plugins/gazebo_omni_plugins_pid';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new gazebo_omni_plugins_pid(null);
...
module.exports = gazebo_omni_plugins_pid;
